 ...
 * |  ?     |   A  |   R  |   S  |   T  |   G  |                              |   M  |   N  |   E  |   I  |   O  |   ' "  |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * | CapsLk |   Z  |   X  |   C  |   D  |   V  | LGUI | LCTL |  |   `  |   &  |   K  |   H  | ,  < | . >  | /  ? | RShift |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |Adjust| LSFT | Del  | Bksp | Esc  |  | Enter| Space| Tab  | LALT | Menu |
 *                        `----------------------------------'  '----------------------------------'
 */
    [_BASE] = LAYOUT(
     ...
     KC_CAPS        , KC_Z ,  KC_X   ,  KC_C  ,   KC_D ,   KC_V , KC_LCTL ,KC_LBRC,         KC_RBRC  , KC_LALT, KC_K   ,   KC_H ,KC_COMM, KC_DOT ,  KC_SLSH , KC_GRV  ,
